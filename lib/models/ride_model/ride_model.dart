...
class RideModel {
  ...
  GeoPoint? pickup_latlng;
  GeoPoint? destination_latlng;
  ...
  RideModel.fromJson(Map<String, dynamic> json) {
    ...
    pickup_latlng = json['pickup_latlng'];
        // LatLng(json['pickup_latlng'].latitude, json['pickup_latlng'].longitude);
    destination_latlng = json['destination_latlng'];
    // LatLng(json['destination_latlng'].latitude, json['destination_latlng'].longitude);
    // codes = json['codes'];
    // phones = json['phones'];
